...
<link rel="stylesheet" href="./style.css" />
  <div>
    ...
    <div class="button-container3"> <button class="back-btn" onclick="goBack()">Back to Form</button></div>
    <div class="konten-container">
      
      <span class="konten-text" id="judul" contenteditable="true">
        <span>BENDAHARA PENGELUARAN MABES TNI&nbsp;</span>
        <span>KU TNI WILAYAH NUSRA NA. 1.01.12</span>
      </span>
      <div class="konten-container01">
        <span class="konten-text03" contenteditable="true">Denpasar, 15 Mei 2024</span>
      </div>
      <div class="konten-container02">
        <div class="konten-container03">
          <span class="konten-text04">
            <span></span>
            <span>Nomor&nbsp;</span>
            <br />
          ...
          <span class="konten-text22">
            <span contenteditable="true" id="nomor">B/66/V/2024</span>
            <br />
            <span contenteditable="true">Biasa</span>
            <br />
            <span contenteditable="true">Satu bendel</span>
            <br />
            <span contenteditable="true" id="uraian">Pengajuan Penyaluran Dana KU TNI Wilayah Nusra</span>
            <br />
          </span>
        </div>
      </div>
      <div class="konten-container04">
        <span class="konten-text31">
          <span>Kepada.</span>
          <br />
        </span>
      </div>
      <div class="konten-container05">
        <span class="konten-text34">
          <span>Yth.</span>
          <br />
        </span>
        <span class="konten-text37" contenteditable="true">
      ...
      <div class="konten-container06">
        <span class="konten-text44">
          <span>di</span>
          <br />
        </span>
      </div>
      <div class="konten-container07">
        <span class="konten-text47">
          <span>Jakarta</span>
          <br />
        </span>
      </div>
      <div class="konten-container08">
        <div class="konten-container09">
          <span class="konten-text50">1.</span>
          <span class="konten-text51">Dasar :</span>
        </div>
      </div>
      <span class="konten-text52" contenteditable="true">
      ...
      <span class="konten-text53" contenteditable="true">
        b.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Surat Perintah Pelaksanaan
        Anggaran Mabes TNI Nomor <span id="SPPA" contenteditable="true">SPPA/263/A.01/2024</span> tanggal 2 Mei 2024
        tentang
        Dukgar Giat Ops Pamtas, Pamtuper, Pamwawan dan Pam Ambalat bulan Mei
        2024.
      </span>

      <span class="konten-text54" contenteditable="true">
        ...
        yang kami terima sebesar <span id="biaya" contenteditable="true">Rp 2.801.020.500,</span>- (Dua Miliar Delapan
        Ratus
      ...
      <span class="konten-text55" contenteditable="true">
        3.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Demikian mohon dimaklumi
        dan mohon petunjuk lebih lanjut&nbsp;
      </span>
      <div class="konten-container10">
        <div class="konten-container11">
          <span class="konten-text56" contenteditable="true">
      ...
      <div class="konten-container12">
        <div class="konten-container13">
      ...
      <div class="home-container14">
        <div class="home-container15">
          <span class="home-text61" contenteditable="true">
  ...
  <script>
    ...
    editableElements.forEach(element => {
        if (element.isContentEditable) {
            ...
            editButton.textContent = 'Simpan Isi Surat';
            editButton.classList.add('edit-mode');
            editButton.classList.remove('save-mode');
        }
    });

    // If in edit mode, update displayed data
